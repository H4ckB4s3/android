...
import org.hns.resolver.util.Configurations;
import org.hns.resolver.util.Logger;
import org.hns.resolver.util.Rule;
...
public class Daedalus extends Application {
    ...
    public static final List<DnsServer> DNS_SERVERS = new ArrayList<DnsServer>() {{
        add(new DnsServer("82.68.70.162", R.string.James));
        add(new DnsServer("82.68.70.163", R.string.James2));
    }};
