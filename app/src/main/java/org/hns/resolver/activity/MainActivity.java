...
import org.hns.resolver.BuildConfig;
import org.hns.resolver.Daedalus;
import org.hns.resolver.R;
import org.hns.resolver.fragment.*;
import org.hns.resolver.service.DaedalusVpnService;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static final String LAUNCH_ACTION = "org.hns.resolver.activity.MainActivity.LAUNCH_ACTION";
    ...
    public static final String LAUNCH_FRAGMENT = "org.hns.resolver.activity.MainActivity.LAUNCH_FRAGMENT";
    ...
    public static final String LAUNCH_NEED_RECREATE = "org.hns.resolver.activity.MainActivity.LAUNCH_NEED_RECREATE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) navigationView.getHeaderView(0)
                .findViewById(R.id.textView_nav_version))
    ...
    private void updateUserInterface(Intent intent) {
        ...
        Log.d(TAG, "Updating UI with Launch Action " + launchAction);
        ...
        if (launchAction == LAUNCH_ACTION_ACTIVATE) {
            ...
            updateMainButton(
                    DaedalusVpnService.isActivated()
                            ? R.string.button_text_deactivate
        ...
        switch (fragment) {
            case FRAGMENT_ABOUT: switchFragment(AboutFragment.class); break;
            case FRAGMENT_DNS_SERVERS: switchFragment(DnsServersFragment.class); break;
            case FRAGMENT_DNS_TEST: switchFragment(DnsTestFragment.class); break;
            case FRAGMENT_HOME: switchFragment(HomeFragment.class); break;
            case FRAGMENT_RULES: switchFragment(RulesFragment.class); break;
            case FRAGMENT_SETTINGS: switchFragment(SettingsFragment.class); break;
            case FRAGMENT_LOG: switchFragment(LogFragment.class); break;
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_github:
                Daedalus.openUri("https://github.com/h4ckb4s3");
                break;
            case R.id.nav_shakeshift:
                Daedalus.openUri("https://shakeshift.com");
                break;
            case R.id.nav_home:
                switchFragment(HomeFragment.class);
                break;
        ...
        InputMethodManager imm = (InputMethodManager)
                Daedalus.getInstance().getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.hideSoftInputFromWindow(
                findViewById(R.id.id_content).getWindowToken(), 0
        );
