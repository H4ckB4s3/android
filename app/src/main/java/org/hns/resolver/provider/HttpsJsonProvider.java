package org.hns.resolver.provider;
...
public class HttpsJsonProvider extends HttpsProvider {
    ...
    protected void sendRequestToServer(IpPacket parsedPacket, DnsMessage message, String uri) {
        ...
        org.minidns.record.Record.TYPE.getType(ans.get("type").getAsInt());
                                        ...
                                        if (recordData != null) {
                                            msg.addAnswer(new org.minidns.record.Record<>(ans.get("name").getAsString(),
                                                    type, 1,
